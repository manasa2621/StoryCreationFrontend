...
import Navbar from "./WebView/HomePage/register";
import axios from "axios";
const WebHomePage = lazy(() => import("./WebView/HomePage/WebHomePage"));
const MobileHomePage = lazy(() =>
  import("./MobileView/HomePage/MobileHomePage")
);
const WebBookmarks = lazy(() => import("./WebView/BookmarkPage/WebBookmarks"));
const MobBookmarks = lazy(() =>
  import("./MobileView/BookmarkPage/MobBookmarks")
);
    ...
    const check = async () => {
      ...
      try {
        const response = await axios.post(
          "https://storycreationbackend.onrender.com/verify-token",
          {},
          {
            headers: {
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/home/bookmarks" element={<WebBookmarks />} />
            </Routes>
          </BrowserRouter>
        </Suspense>
      )}

    ...
    Object.values(slideData).map(async (item, key) => {
      ...
      try {
        const response = await axios.delete(
          `https://storycreationbackend.onrender.com/story/${storyID}`,
          {
            headers: {
      ...
      try {
        setTimeout(async () => {
          const response = await axios.post(
            "https://storycreationbackend.onrender.com/story",
            item,
            {
              headers: {
                "content-type": "application/x-www-form-urlencoded",
...
async function getStoryID() {
  try {
    let id = await axios.get("https://storycreationbackend.onrender.com/storyid");
